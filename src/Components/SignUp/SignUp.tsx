...
const SignUp = () => {
    const { googleSignIn, user, error, setError, handleEmail, handlePassword, handleRegister } = useFirebase();
    return (
        <div className={signIn.bgStyle}>
            <div className={signIn.container}>
                <div className={signIn.formContainer}>
                    ...
                    <form className={signIn.inputContainer} onSubmit={handleRegister}>
                        <>
